		...
		extend: {
			...
			keyframes: {
				...
				'sos-activate': {
					'0%': {
						transform: 'scale(1)',
						boxShadow: '0 0 0 0 hsl(var(--emergency-red) / 0.4)',
					},
					'70%': {
						transform: 'scale(1.05)',
						boxShadow: '0 0 0 20px hsl(var(--emergency-red) / 0)',
					},
					'100%': {
						transform: 'scale(1)',
						boxShadow: '0 0 0 0 hsl(var(--emergency-red) / 0)',
					}
				},
				'fade-in-up': {
					'0%': {
			...
			animation: {
				...
				'sos-activate': 'sos-activate 1s ease-out',
